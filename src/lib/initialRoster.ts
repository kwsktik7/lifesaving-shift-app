...
export const INITIAL_ROSTER: InitialRosterRow[] = [
  ...
  { order: 29, name: '小宮山 暗太',   grade: '4年', role: 'その他',   hasPwc: false },
  { order: 30, name: '山崎 杏未',     grade: '4年', role: 'レク',     hasPwc: false },
  ...
  { order: 38, name: '秋永 大埔',     grade: '2年', role: '競技',     hasPwc: false },
  ...
  { order: 45, name: '嶺絵 麗太',     grade: '2年', role: '競材',     hasPwc: false },
  { order: 46, name: '田中 優衣',     grade: '2年', role: '競材',     hasPwc: false },
  { order: 47, name: '鈴木 桂',       grade: '2年', role: 'レク',     hasPwc: false },
